...
echo "==> Building @i-customize-it/frontend-main (NEXT_PUBLIC_BACKEND_MAIN_API_URL=${NEXT_PUBLIC_BACKEND_MAIN_API_URL})"
npx pnpm@9.15.0 --filter @i-customize-it/frontend-main run build

echo "==> Building @i-customize-it/frontend-admin"
npx pnpm@9.15.0 --filter @i-customize-it/frontend-admin run build
