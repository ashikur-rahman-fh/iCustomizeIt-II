...
| Shared UI/API  | pnpm workspace package `@i-customize-it/shared` (API client, design system, hooks) |
...
packages/shared           Shared TS/React library (`@i-customize-it/shared`)
...
2. ESLint (Next apps + `@i-customize-it/shared`)
...
import { Button } from '@i-customize-it/shared/ui';
```
